...
class MLPTestProblem(ProblemFunction):
    def __init__(self,
        ...
        self.optimizer_class: Any | None = None
        self.fitted = None
    ...
    def fit_and_report_loss(self, **kwargs) -> float:
        ...
        optimizer = self.optimizer_class(training_model.parameters(), **kwargs)
        ...
        for epoch in range(self.max_epochs):
            ...
            if epoch_elapsed > self.max_epoch_time:
                raise TimeoutError(f"Epoch took too long; {epoch_elapsed:.3f} > {self.")
